...
<html lang="en">
  ...
  <div class="container-fluid">
    ...
    <h3>Feb 2021 Readings</h3>

    
    <?php
                    $result = mysqli_query($conn,"SELECT * FROM readings WHERE read_date between '2021-02-01' AND '2021-02-31' ORDER BY read_date ASC;");
                    $yesterday_amount = 0;
